                                ...
                                <li>
                                    <div class="blog-thumb">
                                        <a style="width:100%;height:100%;" href="#">
                                            @if(!empty($r->users))
                                            <img style="width:100%;height:100%;" src="{{ DB::table('users')->where('id' , $r->users)->get()->first()->profileimage }}" alt="">
                                            @else
                                            <img style="width:100%;height:100%;" src="{{ url('images') }}/{{ DB::table('profileimages')->where('id', '>=', 40)->get()->first()->image_name }}" alt="">
                                            @endif
                                        </a>
                                    </div>
                                ...
                                <div style="padding-left: 80px;">
                                    ...
                                    <li>
                                        <div class="blog-thumb">
                                            <a style="width:100%;height:100%;" href="#">
                                                @if(!empty($c->userid))
                                                <img style="width:100%;height:100%;" src="{{ DB::table('users')->where('id' , $c->userid)->get()->first()->profileimage }}" alt="">
                                                @else
                                                <img style="width:100%;height:100%;" src="{{ url('images') }}/{{ DB::table('profileimages')->where('id', '>=', 50)->get()->first()->image_name }}" alt="">
                                                @endif
                                            </a>
                                        </div>
                                        <div class="blog-thumb-info">
