<footer class="footer-4 pt-110">
            <div class="footer-shapes">
                <div class="shape">
                    <img data-parallax='{"x": -50, "y": 0, "rotateZ":0}' src="img/footer/shape-3.png" alt="">
                </div>
                <div class="shape">
                    <img data-parallax='{"x": -00, "y": 0, "rotateZ":0}' src="img/footer/shape-4.png" alt="">
                </div>
                <div class="shape">
                    <img data-parallax='{"x":0, "y": 100, "rotateZ":0}' src="img/footer/shape-5.png" alt="">
                </div>
            </div>
            <div class="container">
